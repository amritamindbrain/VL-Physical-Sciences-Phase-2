	...
	public class Branch extends DynamicMovie{
		...
		public function Branch(type:String) { 
			...
			if(Circuit.isSchematic()){
				...
				if(this.type!="capacitorNew"  && this.type!="longWire" &&  this.type!="Transistor" &&  this.type!="CROinputTerminal"  && this.type!="TransistorBaseJunction" ){
		...
		function startRotate(e:MouseEvent) {
			...
			if(this.type!="wire"){
				...
				if(e.target.parent.type!="CROinputTerminal" && e.target.parent.type!="BatteryShade"){
					e.target.startDrag();
				}
