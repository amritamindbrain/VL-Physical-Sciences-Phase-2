	...
	public class Scroll extends MovieClip{
		...
		function getVal(e:SliderEvent):void{
			...
			this.labelTxt.text="Resistance Resi:"+e.target.value+" Ohm";
				...
				this.labelTxt.text="Capacitance:"+e.target.value+" Nano F";
			}else if(this.name=="inductorScroll"){
				this.labelTxt.text="Inductance:"+e.target.value+" Micro H";
			}
		...
		function updateVal(e:SliderEvent):void{
						...
						}else if(this.name=="sgFreScroll"){
							//this.objt.signalFrq=this.numberStepper.value;
						}else if(this.name=="sgVoltScroll"){
