...
package virtualcircuit.components {
	...
	public class RealCROinput extends MovieClip{
		...
		//public var switchButtonObj:croInput;
		var woodObj1:croInput;
		...
		var myTween:Tween;
		// Initialization:
		public function RealCROinput() { 
			this.woodObj1=new croInput();
			this.woodObj1.x=0;
			this.woodObj1.y=0;
			this.woodObj1.width=100;
			this.woodObj1.height=36;
			this.woodObj1.mouseEnabled=false;
			addChild(this.woodObj1);
