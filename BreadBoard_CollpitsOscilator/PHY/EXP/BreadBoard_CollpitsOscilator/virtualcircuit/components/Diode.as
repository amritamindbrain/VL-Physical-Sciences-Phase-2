package virtualcircuit.components {
	...
	public class Diode extends CircuitComponent{
		...
		// Constants:
		// Public Properties:
		public var schematicComponent:SchematicDiode;
		public var realComponent:RealDiode;
		...
		public function Diode() { 
			...
			//super();
			this.schematicComponent=new SchematicDiode();
			this.realComponent=new RealDiode();
			//this.voltage=9;
