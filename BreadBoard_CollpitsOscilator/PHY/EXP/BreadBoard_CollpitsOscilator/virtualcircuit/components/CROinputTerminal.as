...
package virtualcircuit.components {
	...
	public class CROinputTerminal extends CircuitComponent{
		
		// Constants:
		// Public Properties:
		///public var schematicComponent:SchematicSwitch;
		public var realComponent:RealCROinput;
		...
		// Initialization:
		public function CROinputTerminal() { 
			
			//super();
			//this.schematicComponent=new SchematicSwitch();
			this.realComponent=new RealCROinput();
			
			this.realComponent.width=70;
			trace("this.realComponent.width="+this.realComponent.width);
